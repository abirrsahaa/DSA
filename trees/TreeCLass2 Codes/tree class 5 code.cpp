...
void printTopView(Node* root) {
        ...
        while(!q.empty()) {
				...
				// implementing the logic to find the answer 

				// if not understanding the condition in if consition
				// go throught the pair data structure inm c++
			
                if(topNode.find(hd) == topNode.end()) {
                        //crete entry kyu ki nhi hai 
...
void printBottomView(Node* root) {
        ...
        while(!q.empty()) {
                ...
                //crete entry kyu ki hame last wala hi chahiye
                topNode[hd] = frontNode->data;
